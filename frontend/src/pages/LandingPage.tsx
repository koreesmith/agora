...
const FEATURES = [
  ...
  { icon: '📱', title: 'Mobile apps', desc: 'Native iOS app available now. Android coming soon.' },
        ...
        <div style={{ maxWidth: 960, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 64, flexWrap: 'wrap' }}>
          <div style={{ flex: 1, minWidth: 280 }}>
            ...
            <a
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: 8, backgroundColor: '#000', color: '#fff', padding: '10px 18px', borderRadius: 10, textDecoration: 'none', marginTop: 4 }}
            >

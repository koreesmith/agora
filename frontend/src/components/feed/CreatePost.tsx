    ...
    <div className="card p-4 space-y-3">
      <div className="flex gap-3">
        ...
        <textarea
          ...
          rows={3}
          className="flex-1 resize-none bg-transparent text-sm text-agora-800 dark:text-agora-200 placeholder-agora-400 focus:outline-none"
        />
      </div>
      ...
      <div className="flex items-center gap-2 pt-2 border-t border-agora-100 dark:border-agora-700">
        ...
        <button
          ...
          disabled={(!content.trim() && !imageUrl) || create.isPending || uploading}

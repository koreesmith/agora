...
const FEATURES = [
  ...
  { icon: '📱', title: 'Mobile apps', desc: 'Native iOS and Android apps available now.' },
        ...
        <div style={{ maxWidth: 960, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 64, flexWrap: 'wrap' }}>
          <div style={{ flex: 1, minWidth: 280 }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' as const, marginTop: 4 }}>
              ...
              <a
                href="https://apps.apple.com/us/app/agora-social-network/id6760935134"
                target="_blank"
                rel="noopener noreferrer"
                style={{ display: 'inline-flex', alignItems: 'center', gap: 8, backgroundColor: '#000', color: '#fff', padding: '10px 18px', borderRadius: 10, textDecoration: 'none' }}
              >
              ...
              <a
                href="https://play.google.com/store/apps/details?id=social.agora.app"
                target="_blank"
                rel="noopener noreferrer"
                style={{ display: 'inline-flex', alignItems: 'center', gap: 8, backgroundColor: '#000', color: '#fff', padding: '10px 18px', borderRadius: 10, textDecoration: 'none' }}
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M3.6 2.6a1.5 1.5 0 0 0-.6 1.2v16.4c0 .5.2.9.6 1.2l9-9.7-9-9.1z"/>
                  <path d="M17.5 10.3L5.1 3.1l9.2 9.2 3.2-2z"/>
                  <path d="M5.1 20.9l12.4-7.2-3.2-2-9.2 9.2z"/>
                  <path d="M20.3 10.9l-2.3-1.3-3.5 2.4 3.5 2.4 2.3-1.3a1.4 1.4 0 0 0 0-2.2z"/>
                </svg>
                <div style={{ textAlign: 'left' as const }}>
